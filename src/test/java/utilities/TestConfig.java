...
public class TestConfig{
	...
	public static String server="www.gmail.com";
	public static String from = "hugo.monteiro@doitlean.com";
	public static String password = "hally3nuska";
	public static String[] to ={"hugoarnostibull@gmail.com"};
